...
class Program
{
    static void Main(string[] args)
    {
        ...
        //User user = new User { FirstName = "Yasin", LastName = "Yaman", Email = "yasinyaman985@gmail.com",  PasswordHash= "Yasinyaman.43" };
        //User user1 = new User { FirstName = "Salihcan", LastName = "Özdemir", Email = "salih@gmail.com", PasswordHash = "salih123" };
        //User user2 = new User { FirstName = "Ahmet", LastName = "Özbey", Email = "Özbey43@gmail.com", PasswordHash =  };
